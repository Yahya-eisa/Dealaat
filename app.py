...
# ---------- PDF table builder ----------
def df_to_pdf_table(df, title="Dealaat"):
    ...
    title_text = f" <><><> Dealaat <><><> |{title} | {today} <><><>"
    ...
    table.setStyle(TableStyle([
        ('BACKGROUND', (0, 0), (-1, 0), colors.HexColor("#FFE4E1")),
...
# ---------- Streamlit App ----------
st.set_page_config(page_title="🛒⚡ Dealaat Orders Processor", layout="wide")
st.title("🛒⚡ Dealaat Orders Processor")
st.markdown("...صباح الفل ")
